"""
Genera imagen estilo Tableau del LATAM AF Implementation Funnel.
...
def get_scale_counts(partners):
    ...
    # Solo LATAM
    latam = df[df['OU'].str.contains('LATAM', na=False)].copy()
...
csv_path = DOWNLOAD_DIR / "implementation_summary_LACA.csv"
...
ax.text(LEFT_PAD + (n_cols * COL_W) / 2, fig_h - 0.22,
        "LATAM AF Implementation Funnel",
...
# ── Guardar ───────────────────────────────────────────────────────────────────
out = DOWNLOAD_DIR / "latam_funnel.png"
